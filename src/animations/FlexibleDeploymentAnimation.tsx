...
const SERVER_PATH = 'M208,40H48A16,16,0,0,0,32,56v48a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V56A16,16,0,0,0,208,40Zm0,64H48V56H208v48Zm0,32H48a16,16,0,0,0-16,16v48a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V152A16,16,0,0,0,208,136Zm0,64H48V152H208v48ZM184,72a12,12,0,1,1-12-12A12,12,0,0,1,184,72Zm0,96a12,12,0,1,1-12-12A12,12,0,0,1,184,168Z'

/* Globe icon path (Phosphor, viewBox 0 0 256 256) */
const GLOBE_PATH = 'M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm-8-136v48h16V80ZM104,64h48v8H104Z'

/* Database icon path (Phosphor, viewBox 0 0 256 256) */
const DATABASE_PATH = 'M128,24C74.17,24,32,48.6,32,80v96c0,31.4,42.17,56,96,56s96-24.6,96-56V80C224,48.6,181.83,24,128,24Zm80,152c0,18.75-33.83,40-80,40s-80-21.25-80-40V132.22C66.69,145.73,94.94,152,128,152s61.31-6.27,80-19.78Zm0-96c0,18.75-33.83,40-80,40S48,98.75,48,80s33.83-40,80-40S208,61.25,208,80Z'
  ...
  return (
    <div className="flex justify-center">
      ...
      >
         ...
         *  Section headers
         * ══════════════════════════════════════════════════════════ */}
        <text x="175" y="18" textAnchor="middle"
          fill="var(--text-primary)" fontSize="11" fontWeight="bold"
          fontFamily="system-ui,sans-serif">
          Self-Hosted
        </text>
        <text x="555" y="18" textAnchor="middle"
          fill="var(--text-primary)" fontSize="11" fontWeight="bold"
          fontFamily="system-ui,sans-serif">
          SaaS
        </text>
        ...
        {/* Vertical divider */}
        <line className="fd-divider" x1="370" y1="8" x2="370" y2="338"
        ...
        <rect className="fd-sh-boundary" x={20} y={38} width={320} height={220} rx={10}
          fill="var(--accent)" fillOpacity="0.02"
          stroke="var(--accent)" strokeWidth="1.5" strokeDasharray="6 3" />
        <text x={30} y={53}
          fill="var(--accent)" fillOpacity="0.6" fontSize="7.5"
        ...
        <g className="fd-sh-glow">
          {/* Laptop 1 */}
          <rect x={50} y={62} width={58} height={42} rx={5}
            fill="var(--text-primary)" fillOpacity="0.03"
            stroke="var(--text-muted)" strokeOpacity="0.35" strokeWidth="1.5" />
          <rect x={46} y={106} width={66} height={5} rx={2.5}
          ...
          {/* Laptop 2 */}
          <rect x={130} y={62} width={58} height={42} rx={5}
            fill="var(--text-primary)" fillOpacity="0.03"
            stroke="var(--text-muted)" strokeOpacity="0.35" strokeWidth="1.5" />
          <rect x={126} y={106} width={66} height={5} rx={2.5}
            fill="var(--text-primary)" fillOpacity="0.04"
            stroke="var(--text-muted)" strokeOpacity="0.35" strokeWidth="1" />
        ...
        <g className="fd-sh-glow">
          <rect x={115} y={118} width={110} height={68} rx={8}
            fill="var(--accent)" fillOpacity="0.03"
            stroke="var(--accent)" strokeOpacity="0.35" strokeWidth="1.2" />
          <EdisonLogo x={145} y={120} w={44} h={43} />
          <circle className="fd-pulse-sh" cx="170" cy="138" r="18"
            fill="none" stroke="var(--accent)" strokeOpacity="0.4" strokeWidth="1.2" />
          <text x={170} y={178}
            fill="var(--accent)" fillOpacity="0.7" fontSize="7" textAnchor="middle"
            fontFamily="system-ui,sans-serif" fontWeight="bold">
            Edison On-Prem
          </text>
        </g>
        ...
        <g className="fd-sh-glow">
          <rect x={195} y={185} width={115} height={55} rx={6}
            fill="var(--text-primary)" fillOpacity="0.02"
            stroke="var(--text-muted)" strokeOpacity="0.2" strokeWidth="1" />
          <text x={205} y={198}
            fill="var(--text-primary)" fillOpacity="0.5" fontSize="6.5"
            fontFamily="system-ui,sans-serif" fontWeight="bold">
            Internal MCP
          </text>
          {/* DB + MCP icon */}
        ...
        <g className="fd-sh-lines">
          {/* laptops → Edison */}
          <line className="fd-line" x1="79" y1="111" x2="145" y2="130"
            stroke="var(--text-muted)" strokeOpacity="0.4" strokeWidth="1.2"
            strokeDasharray="3 3" />
          <line className="fd-line" x1="159" y1="111" x2="160" y2="130"
            stroke="var(--text-muted)" strokeOpacity="0.4" strokeWidth="1.2"
            strokeDasharray="3 3" />
          {/* Edison → internal MCP */}
          <line className="fd-line" x1="195" y1="165" x2="235" y2="185"
            stroke="var(--accent)" strokeOpacity="0.4" strokeWidth="1.2"
            strokeDasharray="3 3" />
        </g>

        {/* ── Controlled egress line (crosses boundary) ── */}
        <g className="fd-sh-lines">
          <line className="fd-line" x1="150" y1="175" x2="115" y2="280"
            stroke="var(--accent)" strokeOpacity="0.35" strokeWidth="1.2"
            strokeDasharray="3 3" />
          {/* egress label */}
          <text x={85} y={235}
            fill="var(--accent)" fillOpacity="0.6" fontSize="6.5"
            fontFamily="system-ui,sans-serif" fontWeight="bold"
        ...
        <g className="fd-sh-glow">
          ...
          <text x={200} y={300}
            fill="var(--text-muted)" fontSize="18" fillOpacity="0.35"
            fontFamily="system-ui,sans-serif">
            ···
          </text>
        </g>
        ...
        {/* Self-hosted caption */}
        <text className="fd-sh-label" x="175" y="340" textAnchor="middle"
          fill="var(--accent)" fillOpacity="0.75" fontSize="7.5" fontWeight="bold"
          fontFamily="system-ui,sans-serif">
        ...
        <g className="fd-v-deny" style={{ transformOrigin: '155px 185px' }}>
          <circle cx="155" cy="185" r="7"
            fill={DANGER} fillOpacity="0.12" stroke={DANGER} strokeOpacity="0.5" strokeWidth="1" />
          <line x1="151.5" y1="181.5" x2="158.5" y2="188.5" stroke={DANGER} strokeWidth="1.4" strokeLinecap="round" />
          <line x1="158.5" y1="181.5" x2="151.5" y2="188.5" stroke={DANGER} strokeWidth="1.4" strokeLinecap="round" />
        </g>
        ...
        <g className="fd-saas-glow">
          <text x={540} y={35}
            fill="var(--text-primary)" fillOpacity="0.6" fontSize="7.5" textAnchor="middle"
            fontFamily="system-ui,sans-serif" fontWeight="bold">
            Your Environment
          </text>
          {/* Laptop 1 */}
          <rect x={450} y={42} width={68} height={48} rx={5}
            fill="var(--text-primary)" fillOpacity="0.03"
            stroke="var(--text-muted)" strokeOpacity="0.35" strokeWidth="1.5" />
          <rect x={446} y={92} width={76} height={5} rx={2.5}
            fill="var(--text-primary)" fillOpacity="0.04"
            stroke="var(--text-muted)" strokeOpacity="0.35" strokeWidth="1" />
          <AgentIcon agent={CLAUDE_CODE} x={464} y={50} size={20} />
          <McpIcon x={468} y={74} size={12} color="var(--text-muted)" opacity="0.4" />
          {/* Laptop 2 */}
          <rect x={548} y={42} width={68} height={48} rx={5}
            fill="var(--text-primary)" fillOpacity="0.03"
            stroke="var(--text-muted)" strokeOpacity="0.35" strokeWidth="1.5" />
          <rect x={544} y={92} width={76} height={5} rx={2.5}
            fill="var(--text-primary)" fillOpacity="0.04"
            stroke="var(--text-muted)" strokeOpacity="0.35" strokeWidth="1" />
        ...
        {/* ── Edison Cloud box ── */}
        <g className="fd-saas-glow">
          <rect x={490} y={138} width={130} height={85} rx={8}
            fill="var(--accent)" fillOpacity="0.03"
            stroke="var(--accent)" strokeOpacity="0.35" strokeWidth="1.2" />
          <EdisonLogo x={528} y={144} w={54} h={52.5} />
          <circle className="fd-pulse-saas" cx="555" cy="165" r="22"
            fill="none" stroke="var(--accent)" strokeOpacity="0.4" strokeWidth="1.2" />
          <text x={555} y={212}
            fill="var(--accent)" fillOpacity="0.7" fontSize="7.5" textAnchor="middle"
            fontFamily="system-ui,sans-serif" fontWeight="bold">
            Edison Cloud
          </text>
        </g>
        ...
        <g className="fd-saas-lines">
          <line className="fd-line" x1="484" y1="97" x2="535" y2="142"
            stroke="var(--text-muted)" strokeOpacity="0.4" strokeWidth="1.2"
            strokeDasharray="3 3" />
          <line className="fd-line" x1="582" y1="97" x2="565" y2="142"
            stroke="var(--text-muted)" strokeOpacity="0.4" strokeWidth="1.2"
            strokeDasharray="3 3" />
        </g>
        ...
        <g className="fd-saas-lines">
          <line className="fd-line" x1="525" y1="223" x2="500" y2="260"
            stroke="var(--accent)" strokeOpacity="0.4" strokeWidth="1.2"
            strokeDasharray="3 3" />
          <line className="fd-line" x1="575" y1="223" x2="600" y2="260"
            stroke="var(--accent)" strokeOpacity="0.4" strokeWidth="1.2"
            strokeDasharray="3 3" />
        </g>
        ...
        <g className="fd-v-s1" style={{ transformOrigin: '508px 228px' }}>
          <circle cx="508" cy="228" r="7"
            fill="var(--accent)" fillOpacity="0.12" stroke="var(--accent)" strokeOpacity="0.5" strokeWidth="1" />
          <polyline points="504,228 506.5,230.5 512,224"
        ...
        <g className="fd-v-s2" style={{ transformOrigin: '598px 228px' }}>
          <circle cx="598" cy="228" r="7"
            fill="var(--accent)" fillOpacity="0.12" stroke="var(--accent)" strokeOpacity="0.5" strokeWidth="1" />
          <polyline points="594,228 596.5,230.5 602,224"
            fill="none" stroke="var(--accent)" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
        </g>

        {/* ══ Packets ══ */}
        <g className="fd-pkt fd-pkt-s1"><McpPacket /></g>
        <g className="fd-pkt fd-pkt-s2"><McpPacket /></g>
        <g className="fd-pkt fd-pkt-h1"><McpPacket /></g>
        <g className="fd-pkt fd-pkt-h2"><McpPacket /></g>
        <g className="fd-pkt fd-pkt-h3"><McpPacket /></g>
        <g className="fd-pkt fd-pkt-h4"><McpPacket /></g>
