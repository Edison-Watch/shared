      ...
      >
        ...
        <g>
          ...
          <text x="58" y="38" textAnchor="middle"
            fill="var(--text-primary)" fillOpacity="0.5" fontSize="7" fontFamily="system-ui,sans-serif">
            User
          </text>
        </g>
        ...
        <g>
          ...
          <text x="68" y="180" textAnchor="middle"
            fill="var(--text-primary)" fillOpacity="0.45" fontSize="7" fontFamily="system-ui,sans-serif">
            Agents
          </text>
        </g>
        ...
        <g>
          ...
          <text x="302" y="38" textAnchor="middle"
            fill="var(--text-primary)" fontSize="7" fontWeight="bold" fontFamily="system-ui,sans-serif">
            Admin
          </text>
          <line x1="302" y1="40" x2="302" y2="54"
            stroke="var(--text-muted)" strokeOpacity="0.4" strokeWidth="1" strokeDasharray="2 2" />
        </g>
         ...
         * ══════════════════════════════════════════════════════════ */}
        <g>
          <circle className="ua-pulse" cx="290" cy="139" r="44"
            fill="none" stroke="var(--accent)" strokeOpacity="0.5" strokeWidth="1.5" />

          <rect x={224} y={54} width={132} height={170} rx={12}
          ...
          <text x="290" y="104" textAnchor="middle"
           ...
           */}
          <rect x={234} y={116} width={108} height={88} rx={5}
            fill="var(--text-primary)" fillOpacity="0.03"
            stroke="var(--text-muted)" strokeOpacity="0.25" strokeWidth="1" />
          ...
          <text x="255" y="130" textAnchor="start"
            fill="var(--text-primary)" fillOpacity="0.45" fontSize="6.5" fontFamily="system-ui,sans-serif">
            Policy
          </text>

          {/* Rule A: deny - row y 136-156 (20px) */}
          <g>
            <rect className="ua-rule-a" x={236} y={136} width={104} height={20} rx={3}
              fill={DANGER} fillOpacity="0" />
            <line x1="244" y1="143" x2="249" y2="148" stroke={DANGER} strokeOpacity="0.6" strokeWidth="1.4" strokeLinecap="round" />
            <line x1="249" y1="143" x2="244" y2="148" stroke={DANGER} strokeOpacity="0.6" strokeWidth="1.4" strokeLinecap="round" />
            <text x="255" y="149" fill="var(--text-primary)" fillOpacity="0.45" fontSize="6.5" fontFamily="system-ui,sans-serif">
              deny: delete_*
            </text>
          </g>
          ...
          <g>
            <line x1="244" y1="163" x2="249" y2="168" stroke={DANGER} strokeOpacity="0.6" strokeWidth="1.4" strokeLinecap="round" />
            <line x1="249" y1="163" x2="244" y2="168" stroke={DANGER} strokeOpacity="0.6" strokeWidth="1.4" strokeLinecap="round" />
            <text x="255" y="169" fill="var(--text-primary)" fillOpacity="0.45" fontSize="6.5" fontFamily="system-ui,sans-serif">
              deny: send_email
            </text>
          </g>
          ...
          <g>
            <rect className="ua-rule-c" x={236} y={176} width={104} height={20} rx={3}
              fill="var(--accent)" fillOpacity="0" />
            <circle cx="246.5" cy="186" r="4.5"
              fill="var(--accent)" fillOpacity="0.15" stroke="var(--accent)" strokeOpacity="0.5" strokeWidth="0.8" />
            <text x="246.5" y="188.5" textAnchor="middle"
              fill="var(--accent)" fillOpacity="0.7" fontSize="5.5" fontWeight="bold" fontFamily="system-ui,sans-serif">
              ?
            </text>
            <text x="255" y="189" fill="var(--text-primary)" fillOpacity="0.45" fontSize="6.5" fontFamily="system-ui,sans-serif">
              ask: write_db
            </text>
          </g>
        </g>
         ...
         * ══════════════════════════════════════════════════════════ */}
        <g>
          <rect x={446} y={100} width={84} height={66} rx={8}
            fill="var(--text-primary)" fillOpacity="0.03"
            stroke="var(--text-muted)" strokeOpacity="0.35" strokeWidth="1.5" />
          <McpIcon x={474} y={108} size={28} color="var(--text-muted)" opacity="0.55" />
          <text x="488" y="156" textAnchor="middle"
            fill="var(--text-primary)" fillOpacity="0.5" fontSize="7" fontFamily="system-ui,sans-serif">
            MCP Server
          </text>
          <rect className="ua-mcp-glow" x={442} y={96} width={92} height={74} rx={10}
            fill="var(--accent)" fillOpacity="0" />
        </g>
         ...
         * ══════════════════════════════════════════════════════════ */}
        <g className="ua-p1">
          <line className="ua-line" x1="130" y1="130" x2="224" y2="130"
          ...
          <g className="ua-deny" style={{ transformOrigin: '252px 82px' }}>
            <circle cx="252" cy="82" r="12"
              fill={DANGER} fillOpacity="0.15" stroke={DANGER} strokeOpacity="0.6" strokeWidth="1.2" />
            <line x1="247" y1="77" x2="257" y2="87" stroke={DANGER} strokeWidth="2.2" strokeLinecap="round" />
            <line x1="257" y1="77" x2="247" y2="87" stroke={DANGER} strokeWidth="2.2" strokeLinecap="round" />
          </g>

          <g className="ua-log1">
            <text x="290" y="242" textAnchor="middle"
              fill={DANGER} fillOpacity="0.7" fontSize="8" fontWeight="bold" fontFamily="system-ui,sans-serif">
              Blocked by policy
            </text>
          </g>
          ...
          <g className="ua-log1">
            ...
            <text x="350" y="32" fill="var(--text-primary)" fillOpacity="0.5" fontSize="6" fontFamily="system-ui,sans-serif">
              Logged
            </text>
          </g>
        </g>
        ...
        <g className="ua-p2">
          ...
          <line className="ua-line ua-ask-arrow" x1="224" y1="108" x2="76" y2="58"
            stroke="var(--accent)" strokeOpacity="0.35" strokeWidth="1.5" strokeDasharray="3 3" />

          <line className="ua-line" x1="356" y1="130" x2="446" y2="130"
            stroke="var(--accent)" strokeOpacity="0.4" strokeWidth="1.5" strokeDasharray="3 3" />

          <g className="ua-user-prompt">
            <rect x={80} y={30} width={64} height={28} rx={6}
              fill="var(--accent)" fillOpacity="0.05"
              stroke="var(--accent)" strokeOpacity="0.45" strokeWidth="1" />
            <text x="112" y="48" textAnchor="middle"
              fill="var(--accent)" fillOpacity="0.75" fontSize="7" fontWeight="bold" fontFamily="system-ui,sans-serif">
              Approve?
            </text>
          </g>

          <g className="ua-approve" style={{ transformOrigin: '130px 38px' }}>
            <circle cx="130" cy="38" r="9"
              fill="var(--accent)" fillOpacity="0.15" stroke="var(--accent)" strokeOpacity="0.6" strokeWidth="1" />
            <polyline points="125,38 128,41 135,34"
          ...
          <g className="ua-approve" style={{ transformOrigin: '340px 78px' }}>
            <circle cx="340" cy="78" r="9"
              fill="var(--accent)" fillOpacity="0.12" stroke="var(--accent)" strokeOpacity="0.5" strokeWidth="1" />
            <polyline points="335,78 338,81 345,74"
              fill="none" stroke="var(--accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </g>

          <g className="ua-log2">
            <rect x={240} y={238} width={124} height={50} rx={5}
              fill="var(--text-primary)" fillOpacity="0.03"
              stroke="var(--text-muted)" strokeOpacity="0.2" strokeWidth="1" />
            <text x="250" y="254" fill="var(--text-primary)" fillOpacity="0.5" fontSize="6" fontFamily="system-ui,sans-serif">
              ▸ Agent: write_db
            </text>
            <text x="250" y="268" fill="var(--accent)" fillOpacity="0.7" fontSize="6" fontWeight="bold" fontFamily="system-ui,sans-serif">
              ▸ User approved ✓
            </text>
            <text x="250" y="282" fill="var(--text-primary)" fillOpacity="0.5" fontSize="6" fontFamily="system-ui,sans-serif">
              ▸ User accountable
            </text>
          </g>
          ...
          <g className="ua-log2">
            ...
            <text x="350" y="32" fill="var(--accent)" fillOpacity="0.6" fontSize="6" fontFamily="system-ui,sans-serif">
              Full audit trail
            </text>
          </g>
        </g>
        ...
        {/* ══ PACKETS ══ */}
        <g className="ua-pkt ua-pkt1"><McpPacket /></g>
        <g className="ua-pkt ua-pkt2a"><McpPacket /></g>
        <g className="ua-pkt ua-pkt2c"><McpPacket /></g>
