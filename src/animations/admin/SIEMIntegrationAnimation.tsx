...
// Log/document icon
const LOG_D =
  "M200,24H72A16,16,0,0,0,56,40V64H40A16,16,0,0,0,24,80v96a16,16,0,0,0,16,16H184a16,16,0,0,0,16-16V168h16a16,16,0,0,0,16-16V40A16,16,0,0,0,216,24ZM184,176H40V80H184Zm32-24H200V80a16,16,0,0,0-16-16H72V40H216ZM160,104H64a8,8,0,0,1,0-16h96a8,8,0,0,1,0,16Zm0,32H64a8,8,0,0,1,0-16h96a8,8,0,0,1,0,16Zm0,32H64a8,8,0,0,1,0-16h96a8,8,0,0,1,0,16Z";
    ...
    <div className="flex justify-center">
      ...
      >
        ...
        <McpServer
          x={435}
          y={100}
          iconSvg={POSTGRESQL_SVG}
          iconViewBox="0 0 432.071 445.383"
        />
        <McpServer
          x={435}
          y={165}
          iconSvg={grafanaSvg(id)}
          iconViewBox="0 0 256 279"
        />
        ...
        {/* ══ Tool call packets ══ */}
        <g className="siem-pkt1" fill="currentColor">
          <McpPacket />
        </g>
        <g className="siem-pkt2" fill="currentColor">
          <McpPacket />
        </g>
        <g className="siem-pkt3" fill="currentColor">
          <McpPacket />
        </g>

        {/* ══ Event stream packets ══ */}
        <g className="siem-evt1" fill="currentColor">
          <EventPacket />
        </g>
        <g className="siem-evt2" fill="currentColor">
          <EventPacket />
        </g>
        <g className="siem-evt3" fill="currentColor">
          <EventPacket />
        </g>
