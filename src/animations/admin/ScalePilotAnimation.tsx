    ...
    <div className="flex justify-center">
      ...
      >
        ...
        <DepartmentRow
          y={ROW_YS[0]!}
          dept={DEPTS[0]!}
          className="spa-dept-eng"
        />
        <DepartmentRow
          y={ROW_YS[1]!}
          dept={DEPTS[1]!}
          className="spa-dept-sales"
        />
        <DepartmentRow
          y={ROW_YS[2]!}
          dept={DEPTS[2]!}
          className="spa-dept-fin"
        />
        <DepartmentRow
          y={ROW_YS[3]!}
          dept={DEPTS[3]!}
          className="spa-dept-legal"
        />
        <DepartmentRow
          y={ROW_YS[4]!}
          dept={DEPTS[4]!}
          className="spa-dept-hr"
        />
        ...
        {/* ══ Packets ══ */}
        <g className="spa-pkt spa-pkt-eng">
          <McpPacket />
        </g>
        <g className="spa-pkt spa-pkt-sales">
          <McpPacket />
        </g>
        <g className="spa-pkt spa-pkt-fin">
          <McpPacket />
        </g>
        <g className="spa-pkt spa-pkt-legal">
          <McpPacket />
        </g>
        <g className="spa-pkt spa-pkt-hr">
          <McpPacket />
        </g>
